...
class IgncaScraper(BaseScraper):
    """Scraper for IGNCA (Indira Gandhi National Centre for the Arts)."""
    
    def __init__(self, config, source_name: str = "ignca"):
        """Initialize IGNCA scraper.
