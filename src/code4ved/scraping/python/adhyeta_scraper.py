"""Adhyeta scraper implementation."""
...
class AdhyetaScraper(BaseScraper):
    """Scraper for Adhyeta - Vedic Learning Platform."""
    
    def __init__(self, config, source_name: str = "adhyeta"):
        """Initialize Adhyeta scraper.
