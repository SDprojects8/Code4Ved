...
class TitusScraper(BaseScraper):
    """Scraper for TITUS Database of Indo-European Texts."""
    
    def __init__(self, config, source_name: str = "titus"):
        """Initialize TITUS scraper.
